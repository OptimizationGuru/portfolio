...
const Banner = () => {
  return (
    <section
      id="home"
      className="w-full px-4 md:h-[650px] lg:h-auto md:py-12 lg:py-36 lg:mb-8 border-b-[1px] border-b-blue-300 bg-gradient-to-b from-gray-800 to-black font-titleFont"
    >

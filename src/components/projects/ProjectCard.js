...
const ProjectCard = ({ title, desc, img, liveUrl, githubUrl }) => {
  return (
    <div className="w-full h-[600px] md:h-[500px] lg:h-auto py-10 px-8 rounded-lg shadow-shadowOne flex flex-col bg-gradient-to-r from-bodyColor to-[#202327] group hover:bg-gradient-to-b hover:from-gray-900 hover:gray-900 transition-colors duration-1000">

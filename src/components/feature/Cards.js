...
const Cards = ({ title, desc, icon }) => {
  return (
    <div className="w-full h-[350px] my-[20px] py-0 px-3  lg:w-[85%] lg:h-[400px] lg:px-6 rounded-lg  flex items-center shadow-shadowOne bg-gradient-to-r from-bodyColor to-[#202327] group hover:bg-gradient-to-b hover:from-black hover:to-[#1e2024] transition-colors duration-100 group">
